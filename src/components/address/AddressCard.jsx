      ...
      >
        ...
        <div className={`px-4 py-4 ${
          ...
          <div className="flex flex-col">
            ...
            {/* Stats Boxes - Served & Pending */}
            <div className="border-t border-gray-200 my-3" />
            <div className="grid grid-cols-2 gap-2">
              <div style={{ background: '#201f21', border: '1px solid #363436', borderRadius: 8 }} className="px-3 py-2 rounded-lg text-center">
                <p className="text-xs font-semibold mb-1" style={{ color: '#8a7f87' }}>SERVED</p>
                <p className="text-xl font-bold" style={{ color: '#22c55e' }}>{sortedAttempts.filter(a => a.outcome === 'served').length}</p>
              </div>
              <div style={{ background: '#201f21', border: '1px solid #363436', borderRadius: 8 }} className="px-3 py-2 rounded-lg text-center">
                <p className="text-xs font-semibold mb-1" style={{ color: '#8a7f87' }}>PENDING</p>
                <p className="text-xl font-bold" style={{ color: '#f97316' }}>{Math.max(0, (address.required_attempts || 3) - sortedAttempts.filter(a => a.outcome === 'served').length)}</p>
              </div>
            </div>
            </div>
            </div>
